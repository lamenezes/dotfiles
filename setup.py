...
subprocess.run(['git', 'clone', 'https://github.com/gmarik/vundle.git',
...
subprocess.run(['cp', 'fonts/Sauce Code Powerline Regular.otf',
...
bashrc_venv = subprocess.run(['cat', '.bashrc-extra'], stdout=subprocess.PIPE,
                             universal_newlines=True)
bashrc = subprocess.run(['cat', path.expanduser('~/.bashrc')], stdout=subprocess.PIPE,
                        universal_newlines=True)
